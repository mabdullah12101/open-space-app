...
export {
  ActionType, asyncReceiveTalkDetail,
  asyncToogleLikeTalkDetail, clearTalkDetailActionCreator, receiveTalkDetailActionCreator, toggleLikeTalkDetailActionCreator
};
